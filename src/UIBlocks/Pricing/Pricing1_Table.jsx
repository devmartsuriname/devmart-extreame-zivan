 ...
 * @description Pricing table card with features and CTA button
 * @category Pricing
 * @variant Table Card
 ...
 * - subTitle: string - Plan description
 * - price: number - Plan price
 * - currency: string - Currency symbol
 * - features: array - List of features
 * - btnLink: string - Button URL
 * - btnText: string - Button text
 * - timeline: string - Billing cycle (month/year)
 * - popular: boolean - Show popular badge
 * 
 * @usedIn Digital Agency, Tech Startup, Service Pages
 * @scss sass/shortcode/_pricing.scss
 */
export default function Pricing1_Table({
  title,
  subTitle,
  price,
  currency,
