...
/**
 * @component Hero4_DigitalAgency
 * @description Video modal hero with geometric shapes and parallax
 * @category Hero
 ...
 * - bgUrl: string - Video thumbnail
 * - thumbnailSrc: string - Background image
 * 
 * @usedIn Digital Agency Page
 * @dependencies VideoModal
 * @scss sass/shortcode/_hero.scss (.cs_hero.cs_style_4)
 */
export default function Hero4_DigitalAgency({ videoSrc, bgUrl, thumbnailSrc }) {
  return (
    <section
