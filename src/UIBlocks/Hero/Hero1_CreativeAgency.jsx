 ...
 * @description Text animation hero with video modal and rotating titles
 * @category Hero
 * @variant Creative Agency
 * @theme Both (Light & Dark)
 * 
 * @props
 * - title: string[] - Array of rotating titles
 * - subtitle: string - Hero subtitle
 * - videoSrc: string - YouTube embed URL
 * - bgUrl: string - Video thumbnail background
 * 
 * @usedIn Creative Agency Home Page (/)
 * @dependencies react-text-transition, VideoModal
 * @scss sass/shortcode/_hero.scss (.cs_hero.cs_style_1)
 */
export default function Hero1_CreativeAgency({ title, subtitle, videoSrc, bgUrl }) {
