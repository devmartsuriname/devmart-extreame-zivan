...
/**
 * @component Hero2_MarketingAgency
 * @description Parallax image hero with microphone icon and down arrow
 * @category Hero
 * @variant Marketing Agency
 * @theme Both (Light & Dark)
 * 
 * @props
 * - miniTitle: string - Small title with icon
 * - title: string - Main hero title
 * - subTitle: string - Hero description
 * - thumbnailSrc: string - Parallax background image
 * - mikeIcon: string - Microphone icon path
 * 
 * @usedIn Marketing Agency Page
 * @dependencies react-parallax
 * @scss sass/shortcode/_hero.scss (.cs_hero.cs_style_2)
 */
export default function Hero2_MarketingAgency({
  miniTitle,
  title,
  subTitle,
  thumbnailSrc,
