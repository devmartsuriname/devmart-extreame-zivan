...
/**
 * @component About1_Standard
 * @description Standard about section with image and feature list
 * @category About
 * @variant Standard
 * @theme Both (Light & Dark)
 * 
 * @props
 * - thumbnail: string - Main about image
 * - uperTitle: string - Section subtitle
 * - title: string - Section title
 * - subTitle: string - Description text
 * - featureList: array - List of features with checkmarks
 ...
 */
export default function About1_Standard({
  thumbnail,
  uperTitle,
  title,
  subTitle,
