...
/**
 * @component About3_CTAStyle
 * @description CTA-style about with large title and geometric shape
 * @category About
 * @variant CTA Style
 ...
 */
export default function About3_CTAStyle({ title, subTitle, btnText, btnUrl }) {
  return (
