...
/**
 * @component About5_VideoProgress
 * @description About with video thumbnail and progress bars
 * @category About
 * @variant Video Progress
 * @theme Both (Light & Dark)
 * 
 * @props
 * - variant: string - Style variant class
 * - videoSrc: string - Video file URL
 * - thumbnailSrc: string - Background image
 * - miniTitle: string - Section subtitle
 * - title: string - Section title
 * - subTitle: string - Description
 * - progressBarList: array - Progress items with title and percentage
 * - salesTitle: string - Sales card title (optional)
 * - groth: number - Growth percentage (optional)
 * 
 * @usedIn Digital Agency
 * @scss sass/shortcode/_about.scss (.cs_about.cs_style_2)
 */
export default function About5_VideoProgress({
  variant,
  videoSrc,
  thumbnailSrc,
  miniTitle,
