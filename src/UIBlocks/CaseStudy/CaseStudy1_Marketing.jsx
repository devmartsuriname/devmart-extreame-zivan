...
/**
 * @component CaseStudy1_Marketing
 * @description Interactive case study grid with hover effects
 * @category CaseStudy
 * @variant Marketing Grid
 * @theme Both (Light & Dark)
 * 
 * @props
 * - data: array - Case studies with thumbnailSrc, number, category, title
 * 
 * @usedIn Marketing Agency
 * @dependencies @iconify/react
 * @scss sass/shortcode/_casestudy.scss
 */
export default function CaseStudy1_Marketing({ data }) {
