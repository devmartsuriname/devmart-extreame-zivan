...
export default function CTA1_ImageBackground({
  ...
  return (
    <div
      className={`cs_cta cs_style_1 ${variant ? variant : ''} cs_bg_filed position-relative cs_radius_15 overflow-hidden text-center`}
    ...
    >
      ...
      <div className="cs_cta_in position-relative">
        <h2 className="cs_cta_title cs_fs_50 cs_white_color mb-0">{title}</h2>
